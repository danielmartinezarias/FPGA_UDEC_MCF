...
#
# Generated by export_simulation on Mon Nov 29 01:12:16 -0300 2021
#
################################################################################
...
'-reset_run' switch to the './MemTx_8x1024.sh' script.

./MemTx_8x1024.sh -reset_run
...
./MemTx_8x1024.sh -noclean_files

For more information on the script, please type './MemTx_8x1024.sh -help'.
