...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/danie/Dropbox/physics/multiport interferometer/FPGA/4_core_interferometer_V2/driver_PM/nexysA7_driver_PM/nexysA7_driver_PM.cache/compile_simlib/questa"
  fi
